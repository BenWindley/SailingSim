...
// Sourced from Van Der Zijp
// Accessed: http://www.fox-toolkit.org/ftp/fasthalffloatconversion.pdf
//
...
{    
    ...
    {
        ushort[] baseTable = new ushort[256 * 2];
        for (int i = 0; i < 256; ++i)
        {
            sbyte e = (sbyte)(127 - i);
            if (e > 24)
    ...
    {
        sbyte[] shiftTable = new sbyte[256 * 2];
        for (int i = 0; i < 256; ++i)
        {
            sbyte e = (sbyte)(127 - i);
            if (e > 24)
